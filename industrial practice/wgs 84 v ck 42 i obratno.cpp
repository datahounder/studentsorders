...
printf("perevod iz WGS v CK42 po shirote = %lf \n",WGS84_CK42_Lat,"gradusov"); 
printf("perevod iz CK42 v WGS84 po shirote = %lf \n",CK42_WGS84_Lat,"gradusov"); 
printf("perevod iz WGS v CK42 po dolgote = %lf \n",WGS84_CK42_Long,"gradusov"); 
printf("perevod iz CK42 v WGS84 po dolgote = %lf \n",CK42_WGS84_Long,"gradusov"); 
return 0;
